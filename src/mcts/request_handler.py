...
class RequestHandler:
    ...
    def hanlde_requests(self, timeout=0.001):
...
def main():
    ...
    # Initialize Manager
    manager = RequestHandler(model=model, state_shape=state_shape, num_workers=num_workers)

    # Start Manager Process
    manager_process = mp.Process(target=manager.hanlde_requests)
